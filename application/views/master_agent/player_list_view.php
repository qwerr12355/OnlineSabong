    ...
    <script type="text/javascript">
        $( document ).ready(function() {
            ...
            $("#frmOperator").on('submit', function(e){
                 ...
                 $.ajax({
                   type: "POST",
                   url: "<?php echo base_url(); ?>index.php/MasterAgent/AddNewPlayer",
                   dataType:"json",
                   data:
            ...
            function loadOperator() {
              $.ajax({
                url: "<?php echo base_url(); ?>index.php/MasterAgent/GetPlayerUserRecruits",
                type: "POST",
                dataType:"json",
                async:false,
              ...
              for (var i = 0; i < userArray.length; i++) {
                ...
                _html+='<tr>'
                          ...
                          +'<td><a href="<?php echo base_url(); ?>index.php/MasterAgent/PlayerInfo/'+userArray[i].UserID+'" class="btn"><i class="material-icons">edit</i></button></a>'
                      +'</tr>';
