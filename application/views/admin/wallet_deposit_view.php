              ...
              <div class="container-fluid">
                  <div class="card">
                      <div class="card-content">
                        <h5 class="card-title green-text">Wallet Deposit</span></h5>
                            <div class="row">
                                <div class="col l8 m6 s12">
                                    <form id="frmWalletDeposit">
                                      ...
                                      <button type="submit" id="btnCashIn" class="btn right m-b-15 green">DEPOSIT</button>
                                    </form>
                                </div>
                              ...
                              success: function(result){
                                if(result.success){
                                  ...
                                  var html='<pre><span class="row green-text">Name : '+_selectData[index].Firstname+" "+_selectData[index].Lastname+' </span>'
                                            +'<span class="row green-text">Username : '+_selectData[index].Username+' </span>'
