            ...
            <div class="page-titles">
                <div class="d-flex align-items-center">
                    <h5 class="font-medium m-b-0">Sub-agent</h5>
                    ...
                    <div class="col s12">
                        <div class="card">
                            <div class="card-content">
                              <div class="d-flex no-block align-items-center">
                                  <h5 class="card-title">All Sub-agent</h5>
                                  <div class="ml-auto">
                                      <a class="waves-effect waves-light btn modal-trigger" href="#modal2">ADD NEW SUB-AGENT</a>
                                  </div>
                              </div>
                        ...
                        <div id="modal2" class="modal">
                            ...
                            <div class="modal-content">
                                <h5 class="card-title"> <i class="fas fa-phone-square m-r-10"></i>New Sub-agent</h5>
                                <div class="row">
                                        <div class="row">
    ...
    <script type="text/javascript">
        $( document ).ready(function() {
            ...
            $("#frmOperator").on('submit', function(e){
                 ...
                 $.ajax({
                   type: "POST",
                   url: "<?php echo base_url(); ?>index.php/SubOperator/AddNewSubAgent",
                   dataType:"json",
                   data:
            ...
            function loadOperator() {
              $.ajax({
                url: "<?php echo base_url(); ?>index.php/SubOperator/GetSubAgentUserRecruits",
                type: "POST",
                dataType:"json",
                async:false,
              ...
              for (var i = 0; i < userArray.length; i++) {
                ...
                _html+='<tr>'
                          ...
                          +'<td><a href="<?php echo base_url(); ?>index.php/SubOperator/SubAgentInfo/'+userArray[i].UserID+'" class="btn"><i class="material-icons">edit</i></button></a>'
                      +'</tr>';
